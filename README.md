...
```
cd existing_repo
git remote add origin https://gitlab.com/dlowji/microservice-midterm.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/dlowji/microservice-midterm/-/settings/integrations)
